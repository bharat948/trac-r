...
export default function ExpenseHistoryClient({ initialExpenses, initialTrackers }: ExpenseHistoryClientProps) {
    ...
    const preferences = { currency: 'INR', dateFormat: 'DD/MM/YYYY' };
    ...
    }, [initialExpenses, searchQuery, selectedTracker, dateFrom, dateTo, amountMin, amountMax]);
    ...
    const handleUpdate = async (expenseData: any) => {
        if (selectedExpense) {
    ...
    const getTrackerName = (trackerId: string) => {
        return initialTrackers.find(t => (t._id || t.id) === trackerId)?.name || 'Unknown';
    };
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        >
                            ...
                            {initialTrackers.filter(t => t.isActive).map((tracker) => (
                                            ...
                                            <tr key={expense._id || expense.id} className="hover:bg-gray-50">
                                                <td className="px-3 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                    <div className="flex flex-col">
                                                        <span>{formatDate(new Date(expense.date), preferences.dateFormat)}</span>
